...
{				?>
										<tr>
											...
											<td><?php if($result -> Statuss==1){
												echo "Verified";
											}
											else if ($result->Statuss==0) {
