...
$sql="update tblvehicles set VehiclesTitle=:vehicletitle,VehiclesBrand=:brand,VehiclesOverview=:vehicleoverview,PricePerDay=:priceperday,FuelType=:fueltype,ModelYear=:modelyear,SeatingCapacity=:seatingcapacity where id=:id ";
...
<div class="col-sm-4">
<input type="number" name="priceperday" class="form-control" min='500' max='2000'<?php echo htmlentities($result->PricePerDay);?>" required>
</div>
...
<div class="col-sm-4">
<input type="number" name="modelyear" class="form-control" max='2022' min='2000'<?php echo htmlentities($result->ModelYear);?>" required>
</div>
<label class="col-sm-2 control-label">Seating Capacity<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="number" name="seatingcapacity" class="form-control" min='1' max='3'<?php echo htmlentities($result->SeatingCapacity);?>" required>
</div>
</div>
<div class="hr-dashed"></div>
<div class="form-group">
