...
<div class="col-sm-4">
<input type="number" name="priceperday" class="form-control" min='500' max='2000'  required>
</div>
...
<div class="col-sm-4">
<input type="number" name="modelyear" class="form-control" max='2022' min='2000' required>
</div>
<label class="col-sm-2 control-label">Seating Capacity<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="number" name="seatingcapacity" class="form-control" min='1' max='3' required>
</div>
</div>
<div class="hr-dashed"></div>
