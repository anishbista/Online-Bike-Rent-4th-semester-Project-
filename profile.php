...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      ...
      <?php if($result->Statuss==1)
                { ?>
                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Verified</a>
                           <div class="clearfix"></div>
        </div>

              <?php }else if($result->Statuss==2) { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Denied</a>
            <div class="clearfix"></div>
        </div>
         ...
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
            ...
            <div class="form-group">
              ...
              <input type="date" value="<?php echo htmlentities($result->dob);?>" name="dob" placeholder="dd/mm/yyyy" id="birth-date" type="text">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
            <label class="control-label">License</label> <br>
            <a href="license/<?php echo htmlentities($result->Vimage1);?>">
											<img src="license/<?php echo htmlentities($result->Vimage1);?>"width="300" height="200" style="border:solid 1px #000">
            </div>
